...
public sealed class HashSnapshot
{
    ...
    public string? ImpHashError { get; init; }
}
...
public sealed class BehaviorResult
{
    ...
    public string? SourcePortableExecutablePath { get; init; }
    public required HashSnapshot Before { get; init; }
    public required HashSnapshot After { get; init; }
